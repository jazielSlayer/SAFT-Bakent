...
exports.updateAvance = exports.getAvances = exports.getAvanceEstudiante = exports.getAvance = exports.deleteAvance = exports.createAvance = void 0;
...
var getAvanceEstudiante = exports.getAvanceEstudiante = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var pool, id_estudiante, _yield$pool$query5, _yield$pool$query6, estudianteCheck, _yield$pool$query7, _yield$pool$query8, rows;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          pool = _context3.sent;
          _context3.prev = 3;
          id_estudiante = parseInt(req.params.id_estudiante);
        ...
        case 16:
          ...
          return _context3.abrupt("return", res.status(404).json({
            message: 'No se encontraron avances para este estudiante'
          }));
        case 21:
          res.json(rows);
          _context3.next = 28;
        ...
        case 24:
          ...
          console.error('Error fetching avance estudiante:', _context3.t0);
          res.status(500).json({
            message: 'Error al obtener avances del estudiante'
          });
        case 28:
        case "end":
  ...
  return function getAvanceEstudiante(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var createAvance = exports.createAvance = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
    var pool, _req$body, id_estudiante, id_modulo, responsable, fecha, estado, _yield$pool$query9, _yield$pool$query10, estudianteCheck, _yield$pool$query11, _yield$pool$query12, moduloCheck, validEstados, _yield$pool$query13, _yield$pool$query14, results;
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 18:
          ...
          moduloCheck = _yield$pool$query12[0];
        ...
        case 34:
          ...
          console.error('Error creating avance:', _context4.t0);
        ...
        case 41:
          res.status(500).json({
            message: "Error al crear avance: ".concat(_context4.t0.message)
          });
        case 42:
        case "end":
  ...
  return function createAvance(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var updateAvance = exports.updateAvance = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var pool, _req$body2, id_estudiante, id_modulo, responsable, fecha, estado, id, _yield$pool$query15, _yield$pool$query16, avanceCheck, _yield$pool$query17, _yield$pool$query18, estudianteCheck, _yield$pool$query19, _yield$pool$query20, moduloCheck, validEstados, fields, values, _yield$pool$query21, _yield$pool$query22, results, _yield$pool$query23, _yield$pool$query24, updatedAvance;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 10:
          ...
          avanceCheck = _yield$pool$query16[0];
        ...
        case 28:
          ...
          moduloCheck = _yield$pool$query20[0];
          if (!(moduloCheck.length === 0)) {
            _context5.next = 33;
            break;
          }
        ...
        case 55:
          ...
          updatedAvance = _yield$pool$query24[0];
          res.json({
        ...
        case 61:
          ...
          console.error('Error updating avance:', _context5.t0);
        ...
        case 68:
          res.status(500).json({
            message: "Error al actualizar avance: ".concat(_context5.t0.message)
          });
        case 69:
        case "end":
  ...
  return function updateAvance(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var deleteAvance = exports.deleteAvance = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res) {
    var pool, _yield$pool$query25, _yield$pool$query26, results;
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 14:
          ...
          console.error('Error deleting avance:', _context6.t0);
          res.status(500).json({
  ...
  return function deleteAvance(_x11, _x12) {
