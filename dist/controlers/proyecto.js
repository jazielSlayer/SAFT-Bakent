...
exports.updateProyecto = exports.getProyectos = exports.getProyecto = exports.deleteProyecto = exports.createProyecto = void 0;
...
var getProyecto = exports.getProyecto = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var pool, _req$query, titulo, area_conocimiento, estudiante, _req$query$page, page, _req$query$limit, limit, query, conditions, params, offset, _yield$pool$query3, _yield$pool$query4, rows, _yield$pool$query5, _yield$pool$query6, countResult, totalItems, totalPages;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 23:
          ...
          countResult = _yield$pool$query6[0];
        ...
        case 33:
          ...
          console.error('Error fetching proyectos:', _context2.t0);
        ...
        case 40:
          res.status(500).json({
            message: "Error al obtener proyectos: ".concat(_context2.t0.message)
          });
        case 41:
        case "end":
  ...
  return function getProyecto(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var createProyecto = exports.createProyecto = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var pool, _req$body, id_estudiante, id_docente_guia, id_docente_revisor, titulo, linea_investigacion, area_conocimiento, fecha_entrega, _req$body$fecha_defen, fecha_defensa, _req$body$resumen, resumen, _req$body$observacion, observacion, _req$body$calificacio, calificacion, _yield$pool$query7, _yield$pool$query8, estudianteCheck, _yield$pool$query9, _yield$pool$query10, docenteGuiaCheck, _yield$pool$query11, _yield$pool$query12, docenteRevisorCheck, _yield$pool$query13, _yield$pool$query14, results;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 20:
          ...
          docenteGuiaCheck = _yield$pool$query10[0];
        ...
        case 27:
          ...
          docenteRevisorCheck = _yield$pool$query12[0];
        ...
        case 42:
          ...
          console.error('Error creating proyecto:', _context3.t0);
        ...
        case 49:
          res.status(500).json({
            message: "Error al crear proyecto: ".concat(_context3.t0.message)
          });
        case 50:
        case "end":
  ...
  return function createProyecto(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var updateProyecto = exports.updateProyecto = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
    var pool, _req$body2, id_estudiante, id_docente_guia, id_docente_revisor, titulo, linea_investigacion, area_conocimiento, calificacion, fecha_entrega, fecha_defensa, resumen, observacion, id, _yield$pool$query15, _yield$pool$query16, proyectoCheck, _yield$pool$query17, _yield$pool$query18, estudianteCheck, _yield$pool$query19, _yield$pool$query20, docenteGuiaCheck, _yield$pool$query21, _yield$pool$query22, docenteRevisorCheck, fields, values, _yield$pool$query23, _yield$pool$query24, results, _yield$pool$query25, _yield$pool$query26, updatedProyecto;
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 10:
          ...
          proyectoCheck = _yield$pool$query16[0];
        ...
        case 20:
          ...
          estudianteCheck = _yield$pool$query18[0];
          if (!(estudianteCheck.length === 0)) {
            _context4.next = 25;
            break;
          }
        ...
        case 28:
          ...
          docenteGuiaCheck = _yield$pool$query20[0];
          if (!(docenteGuiaCheck.length === 0)) {
            _context4.next = 33;
            break;
          }
        ...
        case 36:
          ...
          docenteRevisorCheck = _yield$pool$query22[0];
          if (!(docenteRevisorCheck.length === 0)) {
            _context4.next = 41;
            break;
          }
        ...
        case 70:
          ...
          updatedProyecto = _yield$pool$query26[0];
          res.json({
        ...
        case 76:
          ...
          console.error('Error updating proyecto:', _context4.t0);
        ...
        case 83:
          res.status(500).json({
            message: "Error al actualizar proyecto: ".concat(_context4.t0.message)
          });
        case 84:
        case "end":
  ...
  return function updateProyecto(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var deleteProyecto = exports.deleteProyecto = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var pool, _yield$pool$query27, _yield$pool$query28, results;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          _yield$pool$query27 = _context5.sent;
        ...
        case 14:
          ...
          console.error('Error deleting proyecto:', _context5.t0);
          res.status(500).json({
  ...
  return function deleteProyecto(_x9, _x10) {
