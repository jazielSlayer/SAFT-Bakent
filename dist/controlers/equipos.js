    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 5;
          return connection.query("SELECT * FROM equipos WHERE equipo_id = ?", [req.params.id]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          _context4.next = 5;
          return connection.query("INSERT INTO Equipos (nombre, codigo_inventario, categoria_id, laboratorio_id, estado, descripcion, fecha_adquisicion) VALUES (?, ?, ?, ?, ?, ?, ?)", [req.body.nombre, req.body.codigo_inventario, req.body.categoria_id, req.body.laboratorio_id, req.body.tipo_laboratorio, req.body.estado, req.body.descripcion, req.body.fecha_adquisicion]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return connection.query("DELETE FROM Equipos WHERE equipo_id = ?", [req.params.id]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          _context6.next = 5;
          return connection.query("UPDATE Equipos SET ? WHERE equipo_id = ?", [req.body, req.params.id]);
        case 5:
