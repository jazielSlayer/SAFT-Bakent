    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return connection.query("SELECt * FROM categorias_equipos");
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 5;
          return connection.query("SELECT * FROM categorias_equipos WHERE categoria_id = ?", [req.params.id]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          _context3.next = 5;
          return connection.query("SELECT COUNT(*) FROM categorias_equipos");
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          _context4.next = 5;
          return connection.query("INSERT INTO categorias_equipos (nombre, descripcion) VALUES (?, ?)", [req.body.nombre, req.body.descripcion]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return connection.query("DELETE FROM categorias_equipos WHERE categoria_id = ?", [req.params.id]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          _context6.next = 5;
          return connection.query("UPDATE categorias_equipos SET ? WHERE categoria_id = ?", [req.body, req.params.id]);
        case 5:
